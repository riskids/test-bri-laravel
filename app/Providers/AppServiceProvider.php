...
class AppServiceProvider extends ServiceProvider
{
    ...
    {
        // Register component aliases with both dot and hyphen notation
        \Blade::component('backend.breadcrumbs', \App\View\Components\Backend\Breadcrumbs::class);
        \Blade::component('backend-breadcrumbs', \App\View\Components\Backend\Breadcrumbs::class);
        \Blade::component('backend.breadcrumb-item', \App\View\Components\Backend\BreadcrumbItem::class);
        \Blade::component('backend-breadcrumb-item', \App\View\Components\Backend\BreadcrumbItem::class);
